...
using ExitGames.Client.Photon;
    ...
    internal class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// <summary>
        /// Leaves a room with option to come backgroundFillImage later or "for good".
        /// </summary>
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(233) Used in EvLeave to describe if a user is inactive (and might come backgroundFillImage) or not. In rooms with PlayerTTL, becoming inactive is the default case.</summary>
    ...
    ///
    /// There are basically three options for user authentification: Stamp0 at all, the client sets some UserId
    ...
    public class AuthenticationValues
    {
        ...
        /// <summary>The type of custom authentication provider that should be used. Currently only "Custom" or "Stamp0" (turns this off).</summary>
