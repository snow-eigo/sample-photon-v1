        ...
        if (operationResponse.ReturnCode != 0)
        {
            switch (operationResponse.OperationCode)
            {
                case OperationCode.CreateGame:
                    ...
                    {
                        Debug.Log("Create failed on GameServer. Changing backgroundFillImage to MasterServer. Msg: " + operationResponse.DebugMessage);
                    }
                ...
                case OperationCode.JoinGame:
                    if (PhotonNetwork.logLevel >= PhotonLogLevel.Informational)
                    {
                        Debug.Log("Join failed on GameServer. Changing backgroundFillImage to MasterServer. Msg: " + operationResponse.DebugMessage);
